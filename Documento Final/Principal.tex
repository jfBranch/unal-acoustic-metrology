...
\tableofcontents
\cleardoublepage
\addcontentsline{toc}{chapter}{Lista de figuras}  % Incluye la lista de figuras en el índice de contenido
\listoffigures  % Índice de figuras
\cleardoublepage
\addcontentsline{toc}{chapter}{Lista de tablas} % Incluye la lista de tablas en el índice de contenido
