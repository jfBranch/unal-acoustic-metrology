...
\addcontentsline{toc}{section}{Algoritmo de reconocimiento de caracteres}
...
\begin{algorithm}[H]
    ...
    \ForEach{\image $\in$ \images}{
        ...
        \textbf{\hyperref[sec:padding]{Paso 2}:} Escalar y hacer \emph{padding} a \image para hacerla de $32 \times 32$ píxeles.\;
...
\addcontentsline{toc}{section}{Paso 1: Filtro gaussiano}
...
\addcontentsline{toc}{section}{Paso 2: Escalización y \emph{padding}}
\label{sec:padding}
...
\addcontentsline{toc}{section}{Paso 3: Segmentación}
...
\addcontentsline{toc}{section}{Paso 4: Descriptor local SIFT}
...
\addcontentsline{toc}{section}{Paso 5: Reducción de dimensionalidad por análisis de componentes principales (KPCA)}
...
Finalmente, expresando~\eqref{eq:kpca_internal_product} de forma vectorial y matricial se llega a que el problema de autovalores a resolver es:
%
\begin{equation}
...
\addcontentsline{toc}{section}{Paso 6: Clasificador bayesiano normal}
